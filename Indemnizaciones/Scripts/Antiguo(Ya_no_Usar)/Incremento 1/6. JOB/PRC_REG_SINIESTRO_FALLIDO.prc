Create Or Replace Procedure Prc_Reg_siniestro_fallido(pi_fec_rep In date, pi_solicitud In number, pi_siniestro In TY_RPRTE_SNSTRO, po_mensaje Out varchar2)
Is 
Begin 
