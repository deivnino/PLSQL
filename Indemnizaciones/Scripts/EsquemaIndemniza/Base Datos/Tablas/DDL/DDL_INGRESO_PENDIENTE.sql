...
--------------------------------------------------------
  ...
  CREATE TABLE "INGRESO_PENDIENTE" 
   ...
   ALTER TABLE INGRESO_PENDIENTE ADD IDENTIFICACION VARCHAR2(100) NOT NULL;   
...
--------------------------------------------------------
  ...
  DROP INDEX INDEMNIZA.INGRESO_PENDIENTE__IDXV1;
...
--------------------------------------------------------
  ...
  DROP INDEX INDEMNIZA.INGRESO_PENDIENTE__IDX;
