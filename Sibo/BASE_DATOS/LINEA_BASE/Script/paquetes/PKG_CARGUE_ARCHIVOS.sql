...
------------------------
      ...
      CLOB_PRC_DINAMICO     :=CLOB_PRC_DINAMICO ||   CHR(10);
      CLOB_PRC_DINAMICO     :=CLOB_PRC_DINAMICO || '   QUERY_BAD                             :=  ''SELECT 1 AS IDCARGUE, 1 AS IDERRORLINEACARGUE, REGISTRO, NVL(DESCRIPCION , ''''SIN DESCRIPCION'''') FROM '' || NOMBRETABLA_BAD;' ||CHR(10);
