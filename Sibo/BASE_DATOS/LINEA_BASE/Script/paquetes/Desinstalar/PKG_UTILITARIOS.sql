...
IS
  ...
  IS
   SELECT RPT.IDTIPOPAGO AS TIPO_PAGO, COUNT(RPT.IDTIPOPAGO) AS TOTAL_REGISTROS, SUM(PU.VALORTOTAL) AS TOTAL_PAGO
  ...
  CURSOR  CUR_REG_MFEA
  IS
   SELECT RPT.IDTIPOPAGO AS TIPO_PAGO, COUNT(RPT.IDTIPOPAGO) AS TOTAL_REGISTROS, SUM(PMFEA.VALORTOTAL) AS TOTAL_PAGO
   FROM  RESUMEN_CARGUE RES,
         PRELIQ_MFEA PMFEA,
         REL_PRELIQ_TIPOPAGO RPT
  ...
  IS  
   SELECT RPT.IDTIPOPAGO AS TIPO_PAGO, COUNT(RPT.IDTIPOPAGO) AS TOTAL_REGISTROS, SUM(OTR.VALORTOTAL) AS TOTAL_PAGO
   FROM  RESUMEN_CARGUE RES,
         PRELIQ_OTROS OTR,
         REL_PRELIQ_TIPOPAGO RPT
