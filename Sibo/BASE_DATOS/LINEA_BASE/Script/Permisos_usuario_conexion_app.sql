...
BEGIN
EXECUTE IMMEDIATE 'DROP USER C_APP_STG_SIBO';
EXCEPTION WHEN OTHERS THEN
NULL;
END;
/
CREATE USER C_APP_STG_SIBO identified by "Et4hgao12_*" DEFAULT TABLESPACE SIBO_DATOS;
ALTER  USER C_APP_STG_SIBO QUOTA 1024M ON SIBO_DATOS;

GRANT CREATE SESSION TO C_APP_STG_SIBO;
