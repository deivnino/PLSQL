  ...
  BEGIN
    ...
    IF V_TIPARCHIVO  = 4 THEN
      ...
      LOOP
        ...
        FUNC_INSERTA_LIQUIDACION(OT.IDPRELIQ, P_IDCARGUE, V_TIPO_PAGO, V_IDDAVIPLATA) ;
      END LOOP;
    ELSIF V_TIPARCHIVO = 3 THEN
      ...
      LOOP
        ...
        -- Crea el registro de de la liquidacion el rel_preliq_tipo_pago
        FUNC_INSERTA_LIQUIDACION(MF.IDPRELIQ, P_IDCARGUE, V_TIPO_PAGO, V_IDDAVIPLATA) ;
      END LOOP;
    ELSIF V_TIPARCHIVO = 2 THEN
      ...
      LOOP
        ...
        -- Crea el registro de de la liquidacion el rel_preliq_tipo_pago
        FUNC_INSERTA_LIQUIDACION(UA.IDPRELIQ, P_IDCARGUE, V_TIPO_PAGO, V_IDDAVIPLATA) ;
      END LOOP;
    END IF;
